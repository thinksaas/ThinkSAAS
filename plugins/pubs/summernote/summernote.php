...
function summernote($loadjs='load'){
    ...
    if($GLOBALS['TS_USER']) {
        ...
        #表情
        if(is_file('plugins/pubs/summernote/plugin/summernote-ext-emoji.js')) echo '<script src="' . SITE_URL . 'plugins/pubs/summernote/plugin/summernote-ext-emoji.js?v=202105191140"></script>';

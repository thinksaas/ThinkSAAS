...
$sql = "select topicid,typeid,groupid,userid,title,count_comment,count_view,istop,isposts,addtime,uptime from ".dbprefix."group_topics where groupid='$groupid' ".$andType." and isshow='0' order by istop desc,uptime desc limit $lstart,30";
